...
class CallReviewersHandler extends Handler {
    ...
    async handle(payload) {
        ...
        var callAuthors = concernedAuthors.filter((author) => payload.pull_request.body.indexOf(`@${author}`) === -1);
...
export default CallReviewersHandler;
